...
export const stripteaseAds: StripteaseAd[] = [
  ...
  },
  {
    ...
    experience: '3 года',
    verified: true,
    about: 'Танцую профессионально более 10 лет. Специализируюсь на современной хореографии и стриптизе. Выступаю на мероприятиях любого формата.',
    specialties: ['Современная хореография', 'Классический стриптиз', 'Go-go'],
    portfolio: [
      'https://images.unsplash.com/photo-1549298916-b41d501d3772?w=400&h=300&fit=crop',
    ],
    availability: {
  ...
  },
  {
    ...
    experience: '2 года',
    verified: true,
    about: 'Профессиональный танцор, выступаю на частных мероприятиях. Работаю с различными музыкальными стилями.',
    specialties: ['Мужской стриптиз', 'Тематические постановки', 'Lap dance'],
    portfolio: [
      'https://images.unsplash.com/photo-1571902943202-507ec2618e8f?w=400&h=300&fit=crop',
    ],
    availability: {
  ...
  },
  {
    ...
    experience: '5 лет',
    verified: true,
    about: 'Чемпионка региональных соревнований по pole dance. Создаю яркие шоу-программы с использованием профессионального реквизита.',
    specialties: ['Pole dance', 'Акробатический стриптиз', 'Воздушная гимнастика', 'Эротический танец'],
    portfolio: [
      'https://images.unsplash.com/photo-1516826957135-700dedea698c?w=400&h=300&fit=crop',
      'https://images.unsplash.com/photo-1508700115892-45ecd05ae2ad?w=400&h=300&fit=crop',
    ],
  ...
  },
  {
    ...
    experience: '4 года',
    verified: true,
    about: 'Опытный танцор с актёрским образованием. Создаю эмоциональные и запоминающиеся выступления.',
    specialties: ['Мужской стриптиз', 'Акробатика', 'Костюмированные шоу', 'Тематические постановки'],
    portfolio: [
      'https://images.unsplash.com/photo-1534438327276-14e5300c3a48?w=400&h=300&fit=crop',
      'https://images.unsplash.com/photo-1571902943202-507ec2618e8f?w=400&h=300&fit=crop',
    ],
